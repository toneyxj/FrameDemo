package com.xj.framedemo.testrefuresh;
...
//            }
//        }, 1000);
        refreshLayout.setHeaderInsetStart(DensityUtil.px2dip(this,StatusBarUtil.getTitleAndStatusHeight(this)));
        //状态栏透明和间距处理
        StatusBarUtil.darkMode(this);
        StatusBarUtil.setPaddingSmart(this, recyclerView);
        StatusBarUtil.setPaddingSmart(this, findViewById(R.id.lin_bar));
//        StatusBarUtil.setPaddingSmart(this, toolbar);
//        StatusBarUtil.setPaddingSmart(this, findViewById(R.id.gifView));
