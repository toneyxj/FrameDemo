package com.xj.refuresh.internal;
...
import com.xj.refuresh.api.RefreshInternal;
import com.xj.refuresh.api.RefreshKernel;
import com.xj.refuresh.api.RefreshLayout;
import com.xj.refuresh.constant.SpinnerStyle;
import com.xj.refuresh.util.DensityUtil;
import com.xj.refuresh.util.SmartUtil;
...
//    protected SpinnerStyle mSpinnerStyle = SpinnerStyle.Translate;
    ...
    public InternalClassics(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        titleView.setTag(ID_TEXT_TITLE);
        arrowView.setTag(ID_IMAGE_ARROW);
        progressView.setTag(ID_IMAGE_PROGRESS);
        centerLayout.setId(android.R.id.widget_frame);

        LinearLayout.LayoutParams lpHeaderText = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        centerLayout.addView(titleView, lpHeaderText);

        RelativeLayout.LayoutParams lpHeaderLayout = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
